...
library TreeMap {
  ...
  /// @return index
  /// @return entry (index of the newly created entry, its storage pointer)
  ...
  /// @return newRootIdx index of the new root node
  ...
  /// @param _key key with which the specified value is to be associated
  /// @param _value value to be associated with the specified key
  /// @return entry storage pointer to entry corresponding to the key
  ...
  /// @param _value value to be associated with the specified key
  /// @return replaced 
  /// @return oldValue (wether value is replaced, value associated with the key before replacement)
  ...
  /// @return removed
  /// @return oldValue (whether a mapping has been removed, the value associated with the `key` before removal)
  ...
  /// @return found 
  /// @return value (whether a mapping with `key` exists, the value associated with the `key`)
  ...
  /// @return value the value associated with the `key` or `defaultValue` if not found
  ...
  /// @return found 
  /// @return key 
  /// @return value whether such entry exists and its key and value
  ...
  /// @return found
  /// @return index whether `_key` already existed in the map and its index (or insertion index if not found)
