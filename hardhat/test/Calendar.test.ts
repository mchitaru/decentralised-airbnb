...
describe("Calendar.sol", () => {
  ...
  describe("availability", () => {
    ...
    it("blocks after reservation", async () => {
      ...
      await calendar.connect(renter1Sig).reserve(0, 1000, 2000);
      await calendar.connect(renter1Sig).reserve(0, 3000, 4000);
  ...
  describe("cancellation", () => {
    before(async () => {
      ...
      await calendar.connect(renter1Sig).reserve(0, 4000, 5000);
      await calendar.connect(renter2Sig).reserve(0, 2500, 2700);
    });
  ...
  describe("batch cancellation", () => {
    before(async () => {
      ...
      await calendar.connect(renter1Sig).cancelAll(0, 1000, 4000);
    });
  ...
  describe("getters", () => {
    before(async () => {
      ...
      await calendar.connect(renter1Sig).reserve(0, 1000, 2000);
      await calendar.connect(renter1Sig).reserve(0, 3000, 3500);
      await calendar.connect(renter1Sig).reserve(1, 4000, 5000);
    ...
    it("return reservation details for a calendar", async () => {
      ...
      startTime.should.be.equal(ethers.BigNumber.from(2500));
      stopTime.should.be.equal(ethers.BigNumber.from(2700));
    ...
    it("return reservation details for a renter", async () => {
      ...
      startTime.should.be.equal(ethers.BigNumber.from(4000));
      stopTime.should.be.equal(ethers.BigNumber.from(5000));
